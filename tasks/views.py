...
def tasks(request):
    ...
    if query:
        ...
        task_list = task.objects.filter(user=request.user, dia_completado__isnull=True)
...
def tasks_completed(request):
    task_list = task.objects.filter(user=request.user, dia_completado__isnull=False ).order_by('-dia_completado')
